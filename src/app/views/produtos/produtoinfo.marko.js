...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.prod, function(produto) {
    ...
    out.w("<div class=\"container-fluid\"><div class=\"row bg-danger\"><div class=\"col-sm-4\" style=\"background-color:lavender;\"><img class=\"m-5\"" +
      ...
      " style=\"width:50%;\"></div><div class=\"col-sm-8\" style=\"background-color:lavenderblush; text-align: right;\"><p> <h1>" +
      marko_escapeXml(produto.Descricao) +
      "</h1> </p><div class=\"\">" +
      marko_escapeXml(produto.Preco) +
      "</div> <div class=\"\">" +
      marko_escapeXml(produto.idProduto) +
      "</div> <button class=\"btn btn-success my-2 my-sm-0\" type=\"submit\">Adicionar ao carrim</button></div></div></div>");
  });
